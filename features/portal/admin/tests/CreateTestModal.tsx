...
import { BulkQuestion } from '../../../../lib/utils/bulk-upload-parser'
...
export const CreateTestModal: React.FC<CreateTestModalProps> = ({
  ...
  // Function to handle bulk question uploaded
  const handleBulkQuestionsUploaded = (bulkQuestions: BulkQuestion[]) => {
    // Convert bulk questions to the format expected by your component
    const convertedQuestions = bulkQuestions.map((q, index) => ({
      questionText: q.questionText,
      options: q.options,
      correctAnswer: q.correctAnswer,
      points: q.points,
      order: questions.length + index, // Append to existing questions
    }))
    ...
    toast({
      ...
      description: `Added ${bulkQuestions.length} questions from bulk upload`,
      status: 'success',
      duration: 3000,
    })
  }
  ...
  return (
    <>
            ...
            {createdTest ? (
              ...
              >
                ...
                <AlertDescription maxWidth="sm" textAlign="center">
                  ...
                  <Text mt={2}>
                    Share this access code with students to allow them to take
                    the test.
                  </Text>
                </AlertDescription>
              </Alert>
              ...
              <VStack spacing={6}>
                  ...
                  <Box mt={6} p={4} bg="gray.50" borderRadius="md">
                    ...
                    <Alert status="info" mt={4} size="sm">
                      ...
                      <Box>
                        ...
                        <Text fontSize="xs">
                          • Shuffle Questions: Randomizes question order for
                          each student
                          <br />
                ...
                <Box width="100%">
                  {/* Add this button in your questions section (where you have
                  "Add Question" button) */}
            ...
            {!createdTest && (
              <>
                ...
                <Button
                  ...
                  isDisabled={
                    !testData.testName.trim() || questions.length === 0
                  }
                >
                  Create Test
                </Button>
      ...
      <BulkUploadModal
        ...
        onQuestionsUploaded={handleBulkQuestionsUploaded}
      />
    </>
  )
}
