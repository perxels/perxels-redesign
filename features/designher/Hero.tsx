  ...
  return (
    ...
    >
            ...
            >
                ...
                Perxels is organizing its annual Portfolio Review, and this year, in celebration of Portfolio Day, we are excited to announce a portfolio competition with a cash prize!
                </Text>
            </Box>
            <Button 
            as={'a'}
            ...
            <Box width={["100%","40%"]}>
                <Image src={"/assets/images/designher/portfolioHero.png"} alt="DesignHER" />
            </Box>
        </Flex>
