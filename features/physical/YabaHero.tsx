...
export const YabaHero = () => {
  ...
  return (
    <Box
    background={[`url(/assets/images/class-group/yabaImage.png) no-repeat center center`,`url(/assets/images/class-group/abujaImage.jpeg) contain no-repeat center center`]}
