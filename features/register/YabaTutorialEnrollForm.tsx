import {
  ...
  const YabaTutorialEnrollForm = () => {
    ...
    const scriptUrl = "https://script.google.com/macros/s/AKfycbz8DJk0FpcalV4YWBYRgn7I7v79ESS_cKDX3S_og9f8SCmag9gecO9P4qRG6eujm5u2/exec"
          ...
          >
            {(formik) => (
              ...
              >
                ...
                <Select
                  h="3.5rem"
                  placeholder="Are you prepared to pay the tuition fee of ₦70,000?"
                  _placeholder={{ color: 'brand.dark.200' }}
                  color="brand.dark.200"
                  name="canPayTuition"
  ...
  export default YabaTutorialEnrollForm