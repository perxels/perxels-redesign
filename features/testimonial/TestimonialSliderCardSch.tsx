...
import {
  ...
  setTestimonials,
} from '../../state/features/TestimonialSchl'
...
export const TestimonialSliderCard = ({
  ...
  const { selectedTestimonialSchl, testimonials } = useAppSelector(
    (state) => state.testimonialSch,
  )

  function handleSliderCardClick() {
    const prevSelectedTestimonial = selectedTestimonialSchl
    let fullTestimoials: any = [...testimonials]
    fullTestimoials.push(fullTestimoials.shift())
    dispatch(
