...
import { TestimonialSliderCard } from './TestimonialSliderCardSch'

export const TestimonialSlider = () => {
  const dispatch = useAppDispatch()
  const { testimonials } = useAppSelector((state) => state.testimonialSch)
      ...
      >
        ...
        >
          ...
          <TestimonialSliderCard
            ...
            imgUrl={testimonials[0]?.imgUrl}
            id={testimonials[0]?.id}
            active={true}
            smallImgUrl={testimonials[0]?.smallImgUrl}
