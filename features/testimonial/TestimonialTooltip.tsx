...
const TestimonialTooltip = () => {
  ...
  return (
    ...
    >
      {active && (
        <SlideFade in={active} offsetY="20px">
          ...
          >
            <Box pb="0.71875rem">
              <Center>
                <Text fontSize={'1.125rem'} color="#121212" fontWeight="700">
                  NIGERIA 🇳🇬
                </Text>
              </Center>
            </Box>
            ...
            <Box>
              <HStack>
                ...
                <Box>
                  <Text fontSize={'0.634375em'} color="#969696">
                    +100
                  </Text>
                </Box>
              </HStack>
              <Box
                ...
                pt={'0.5rem'}
              >
                <Text fontSize={'0.625em'} fontWeight={'700'} color="#121212">
                  Read their stories
                </Text>
                <Text fontSize={'1rem'}>
                  <AiOutlineArrowRight />
      ...
      <Box
        boxSize={['1rem', '1.875rem', '1.875rem']}
        animation={pulseAnimation}
      >
        <Img src="/assets/icons/locationPoint.svg" alt="testimonial image" />
      </Box>
    </Box>
  )
}
