...
import { setSelectedTestimonial } from '../../state/features/TestimonialSchl'

import { testimonialSliderContentScholarship } from '../../constant'
...
export const MobileTestimonialSlider = () => {
  ...
  return (
    <Box>
      <Slider {...settings}>
        {testimonialSliderContentScholarship.map(
