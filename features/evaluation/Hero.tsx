    ...
    <MainContainer>
      ...
      >
        <Box width={['100%', '60%']}>
          ...
          <Heading
            fontSize={['2.1875rem', '3.625rem']}
            fontWeight="800"
            lineHeight={['2.4875rem', '4rem']}
          >
            Evaluate competencies with design examination
          </Heading>
          <Text
            fontSize={['1rem', '1.175rem']}
            color={'#1A1A1A'}
            lineHeight={['1.3rem', '1.675rem']}
            mt={['1rem', '1.5rem']}
            w={['100%', '70%']}
          >
            Elevate your UI/UX design career by obtaining certification through
            examination. Enhance your CV and gain a competitive edge in the
            field
          </Text>
          <Flex
            mt={['1rem', '1.675rem']}
